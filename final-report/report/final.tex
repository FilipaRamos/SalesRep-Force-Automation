...
\HRule \\[1.2cm]
{ \huge \bfseries \textit{Sales Force Automation}}\\[0.6cm] % Title of your document
...
Turma 4MIEIC02, Grupo C\\[0.2cm] 
\small Filipa \textsc{Ramos}\\[0.1cm] 
...
Para tal, existem soluções \textit{SFA} – \textit{Sales Force Automation} –, software que permite automatizar tarefas como controlo de inventário, processo de vendas, e registo de interações com clientes. São normalmente integradas na componente de \textit{Customer Relationship Management (CRM)} de um sistema de \textit{Enterprise Resource Planning (ERP)}, existindo várias alternativas no mercado: \textit{SAP CRM (Sales)}, \textit{Microsoft Dynamics CRM} e \textit{Oracle Siebel} são alguns exemplos.

Realizado no âmbito da unidade curricular de Sistemas de Informação, o presente documento detalha a especificação de uma aplicação web que oferecerá as funcionalidades de uma solução \textit{SFA}. Ao longo do documento, é feita uma descrição do projeto, enumerando-se as funcionalidades a implementar, e identificam-se os pontos de ligação com o \textit{ERP} Primavera. 
...
///////////////////////////////////////////////////////////////////////////////////
O projeto consiste no desenvolvimento de uma aplicação web que oferecerá as funcionalidades de uma solução \textit{SFA}. Existirá uma camada de autenticação, através da qual um supervisor e os representantes de vendas deverão autenticar-se, para que possam organizar da sua agenda, manter o registo dos seus contactos com clientes e registar ordens de venda.
 
A aplicação web será desenvolvida utilizando Node.js. Porque com este trabalho se pretende, também, adquirir conhecimentos no que respeita ao uso de um ERP – no caso, o Primavera – prevê-se, igualmente, a criação de um servidor back-end em \textit{C\#}, que fara a comuniação com o Primavera, passando a informação à aplicação front-end atraves de uma API RESTful. 

\subsection{Core Views}

\subsubsection{Client Page: Display of client information and transaction history}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View Client Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{Homepage: Overview of schedule}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View Homepage.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\hline
...
\subsubsection{Meeting Page: Overview of meeting}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View Meeting Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{New Client Page: Create page for new potencial client}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View New Client.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{New Meeting Page: Schedule meeting with client}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View New Meeting Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{New Order Page: Sell products to client}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View New Order Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{Order Status Page: Overview of order status}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View Order Status Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{Product Page: Overview of product}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View Product Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
...
\subsubsection{Catalog Page: List of products}

\begin{figure}[H]
  \centering
    \includegraphics[width=9cm, height = 10.5cm]{SINF_cataloguepage.png}
  \caption{Core View da página do catálogo.}
  \label{uml}
\end{figure}

\begin{table}[H]
\centering
\caption{Especificação da Core View Catalog Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
ID CORE VIEW                                                   & CAT\_PAGE                                                                                                                                                                                                                                                                   \\ \midrule
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Meeting Page;\\ -Administration Page;\\ -Search.\end{tabular}                                                                                                                                                                                                 \\ \midrule
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Allows the user to see the products for sale in detail.\end{tabular} \\ \midrule
\begin{tabular}[c]{@{}c@{}}ELEMENTS OF\\ THE CORE\end{tabular} & Product List                                                                                                                                                                                                                             \\ \bottomrule
\end{tabular}
\end{table}

\subsubsection{Administration Page: Overview of sales and sales team}
...
\begin{table}[H]
\centering
\caption{Especificação da Core View Administration Page.}
\label{my-label}
\begin{tabular}{@{}cl@{}}
\toprule
ID CORE VIEW                                                   & ADMIN\_PAGE                                                                                                                                                                                                                                                                   \\ \midrule
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Sign In.\end{tabular}                                                                                                                                                                                                 \\ \midrule
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Allows the user to see the sales representatives with the \\ most clients or  with the largest sales volume; \\ -Allows the user to see prospect clients or with the largest \\ sales volume; \\ -Enables the user to see an overview of sales, including the \\ best selling products.\end{tabular} \\ \midrule
\begin{tabular}[c]{@{}c@{}}ELEMENTS OF\\ THE CORE\end{tabular} & Sales Representative List, Clients List and Sales Overview                                                                                                                                                                                                                             \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|c|}
		...
		REGISTER\_REPRESENTATIVE           & Registar um representante de vendas  &    \\ \hline
		...
		VIEW\_TOP\_ORDERS           & \begin{tabular}[c]{@{}l@{}}Ver uma lista com as encomendas de maior valor.\end{tabular}  & ADMIN\_PAGE  \\ \hline
		VIEW\_PRODUCT\_CATALOGUE           & Ver a lista de produtos  & CAT\_PAGE \\ \hline
		VIEW\_EVENTS           & Consultar atividades agendadas                                                                                                                                 & HOM\_PAGE \\ \hline
...
\textbf{Path}                              & \url{http://<domain>/api/client?id=<clientID>}                                                                                                                                                          \\ \hline
...
\textbf{Path}                              & \url{http://<domain>/api/client}                                                                                                                                                          \\ \hline
...
\textbf{Core Views}                        & 
\\ \hline
\textbf{Path}                              & \url{http://<domain>/api/meeting?id=<meetingID>}                                                                                                                                                          \\ \hline
...
\textbf{Path}                              & \url{http://<domain>/api/warehouse?id=<warehouseID>}                                                                                                                                                          \\ \hline
\textbf{Verb}                              & \multicolumn{1}{c|}{GET}                                                                                                                                                                                                \\ \hline
...
\begin{table}[H]
 ...
 \\ \hline
		...
		\textbf{Path}                              & \url{http://<domain>/api/transaction?id=<transactionID>}                                                                                                                                                          \\ \hline
		\textbf{Verb}                              & \multicolumn{1}{c|}{GET}                                                                                                                                                                                                \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|}
		...
		\textbf{Core Views}                        & \multicolumn{1}{c|}{PRO\_PAGE}                                                                                                                                                                                                                        \\ \hline
		\textbf{Path}                              & \url{http://<domain>/api/article?id=<articleID>}                                                                                                                                                          \\ \hline
		\textbf{Verb}                              & \multicolumn{1}{c|}{GET}                                                                                                                                                                                                \\ \hline
		\textbf{Input}                             & \multicolumn{1}{c|}{articleID}                                                                                                                                                                                           \\ \hline
		\textbf{Output}                            & \begin{tabular}[c]{@{}l@{}}\{\\  "nome": "nome artigo",\\ "descricao": "descricao artigo",\\ "preco\_atual": 12.5,\\ "iva\_atual": 13, \\ "stock\_total": 100, \\ "stock\_disponivel": 85 \\ \}\end{tabular} \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|}
		\hline
		\textbf{Webservice ID}                     & \multicolumn{1}{c|}{get\_all\_article}                                                                                                                                                                                        \\ \hline
		\multicolumn{1}{|l|}{\textbf{Description}} & Retorna todos os artigos.                                                                                                                                                                                    \\ \hline
		\textbf{Core Views}                        & \multicolumn{1}{c|}{CAT\_PAGE}                                                                                                                                                                                                                        \\ \hline
		\textbf{Path}                              & \url{http://<domain>/api/articles}                                                                                                                                                          \\ \hline
		\textbf{Verb}                              & \multicolumn{1}{c|}{GET}                                                                                                                                                                                                \\ \hline
		\textbf{Input}                             & \multicolumn{1}{c|}{}                                                                                                                                                                                           \\ \hline
		\textbf{Output}                            & \begin{tabular}[c]{@{}l@{}}\{\\  "artigos": [ \\ \{"nome": "nome artigo",\\ "descricao": "descricao artigo",\\ "preco\_atual": 12.5,\\ "iva\_atual": 13, \\ "stock\_total": 100, \\ "stock\_disponivel": 85  \}, ... ] \\ \}\end{tabular} \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|l|}
		\hline
		\textbf{Webservice ID}                     & \multicolumn{1}{c|}{get\_warehouse\_stock}                                                                                                                                                                                        \\ \hline
		\multicolumn{1}{|l|}{\textbf{Description}} & Retorna o stock de um artigo específico num armazém.                                                                                                                                                                                    \\ \hline
		\textbf{Core Views}                        & \multicolumn{1}{c|}{PRO\_PAGE}                                                                                                                                                                                                                        \\ \hline
		\textbf{Path}                              & \url{http://<domain>/api/warehouse\_article?article=<articleID>&warehouse=<warehouseID>}                                                                                                                                                          \\ \hline
		\textbf{Verb}                              & \multicolumn{1}{c|}{GET}                                                                                                                                                                                                \\ \hline
		\textbf{Input}                             & \multicolumn{1}{c|}{artigoID, armazemID}                                                                                                                                                                                           \\ \hline
...
\section{Especificação vs Implementação}
«Project Specifications vs Delivered Project»
