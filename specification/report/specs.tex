...
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Homepage;\\ -Meeting Page;\\ -Order Page.\end{tabular}                                                                                                                                                                                                                                            \\
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Allows the user to see detailed client information;\\ -Displays complete history of pending, completed\\ and canceled orders;\\ -Allows starting a new order with the client;\\ - Display history of meetings with client;\\ -Allows scheduling a new meeting with the client.\end{tabular} \\
...
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Homepage;\\ -Client Page.\end{tabular}                                                                                                                                                                      \\
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Allows the user to see detailed client information;\\ -Allows the user to take relevant notes after the meeting;\\ -Shows the detailed list of selling opportunities proposed\\ to the client.\end{tabular} \\
...
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Homepage;\\ -Client Page.\end{tabular}                                                                                                                                                                                                                                \\
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Enables the scheduling of new meetings with clients;\\ -Verifies if different meetings do not overlap each other;\\ -Enables to select the products to sell and access their \\ respective pages;\\ -Enables to take important notes before the meeting.\end{tabular} \\
...
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Client Page;\\ -Meeting Page.\end{tabular}                                                                         \\
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Allows user to see specific information about the client;\\ -Enables the creation of complete orders.\end{tabular} \\
...
INWARD PATHS                                                   & -Client Page.                                                                                                                                                                     \\
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Allows user to see the order status;\\ -Enables user to access client information;\\ -Enables user to see detailed information of order.\end{tabular} \\
...
INWARD PATHS                                                   & \begin{tabular}[c]{@{}l@{}}-Order Page;\\ -Meeting Page.\end{tabular}                                                                                                                                                                                                 \\
OUTWARD PATHS                                                  & \begin{tabular}[c]{@{}l@{}}-Enables the user to see detailed information about a product;\\ -Enables the user to check availability of a product in several\\ warehouses and respective stock;\\ -Enables user to request a defined quantity of product units.\end{tabular} \\
